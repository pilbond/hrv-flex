...
SSM_RESEARCH_REPORT_DIR = Path(__file__).resolve().parent.parent / "research" / "reports" / "ssm_validation"
SSM_VALIDATION_REPORT_JSON_PATH = SSM_RESEARCH_REPORT_DIR / "ENDURANCE_HRV_ssm_validation_report.json"
SSM_VALIDATION_REPORT_MD_PATH = SSM_RESEARCH_REPORT_DIR / "ENDURANCE_HRV_ssm_validation_report.md"
SSM_OUTCOME_BATTERY_JSON_PATH = SSM_RESEARCH_REPORT_DIR / "ENDURANCE_HRV_ssm_outcome_battery.json"
SSM_OUTCOME_BATTERY_MD_PATH = SSM_RESEARCH_REPORT_DIR / "ENDURANCE_HRV_ssm_outcome_battery.md"
