...
def session_report_evidence(summary: dict[str, Any]) -> list[tuple[str, str]]:
    ...
    if isinstance(row, dict):
        ...
        run_power_available = _parse_float(row.get("run_power_available"))
        polar_speed_available = _parse_float(row.get("polar_speed_available"))
        polar_cadence_available = _parse_float(row.get("polar_cadence_available"))
        if is_run and (
            ...
            run_power_mean = _parse_float(row.get("run_power_mean"))
            speed_first_half = _parse_float(row.get("speed_first_half"))
            speed_second_half = _parse_float(row.get("speed_second_half"))
            cadence_first_half = _parse_float(row.get("cadence_first_half"))
            cadence_second_half = _parse_float(row.get("cadence_second_half"))
