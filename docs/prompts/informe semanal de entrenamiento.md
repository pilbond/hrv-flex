...
- Si existe `data/ENDURANCE_HRV_weekly_coach.json`, usa `planning_note` como punto de partida breve para la Seccion 7, pero sin copiarla de forma literal si la evidencia de la semana pide matizarla.
